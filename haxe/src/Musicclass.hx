...
class Musicclass extends Sprite
{
    ...
    public function changeamb(t : Int) : Void
    {
        if (currentamb != t)
        {
            if (currentamb != -1)
            {
                ...
                currentambchan = 0;
                stopother = 0;
                if(ambchannel != null) ambchannel.stop();
                if (amb2active && ambchannel2 != null)
                {
                    ambchannel2.stop();
                }
            }
    ...
    public function processmusicfade() : Void
    {
        ...
        if (musicfade > 0)
        {
            ...
            {
                if(musicchannel != null) musicchannel.soundTransform = new SoundTransform(musicfade / 60);
            }
            if (currentmusicchan == 1)
            {
                if(musicchannel2 != null) musicchannel2.soundTransform = new SoundTransform(musicfade / 60);
            }
        }
        else
        {
            ...
            if (currentmusicchan == 1)
            {
                if(musicchannel2 != null) musicchannel2.stop();
            }
            currentsong = -1;
        }
    }
    ...
    public function processmusic() : Void
    {
        ...
        if (musicchancur <= 0 && currentsong > -1 && musicchanlen > 0)
        {
            ...
            if (currentmusicchan == 0)
            {
                if(musicchan[currentsong] != null) musicchannel2 = musicchan[currentsong].play();
                musicstopother = 3;
                currentmusicchan = 1;
            }
            else
            {
                if(musicchan[currentsong] != null) musicchannel = musicchan[currentsong].play();
                musicstopother = 3;
                currentmusicchan = 0;
            }
        }
    ...
    public function play(t : Int) : Void
    {
        if (currentsong != t)
        {
            ...
            if (t != -1)
            {
                ...
                {
                    musicfadein = 61;
                    if(musicchan[currentsong] != null) musicchannel = musicchan[currentsong].play(0, 0, new SoundTransform(0));
                }
                else
                {
                    if(musicchan[currentsong] != null) musicchannel = musicchan[currentsong].play();
                ...
                if (musicchanlen < 0)
                {
                    if(musicchannel != null) musicchannel.addEventListener(Event.SOUND_COMPLETE, stopmusic);
                }
            }
            else
            {
    ...
    public function stopstep() : Void
    {
        if (step1playing)
        {
            if(stepchannel != null) stepchannel.stop();
            step1playing = false;
        }
        if (step2playing)
        {
            if(stepchannel != null) stepchannel2.stop();
            step2playing = false;
        }
        currentstep = -1;
    }
    ...
    public function processamb() : Void
    {
        ...
        if (stopother == 1)
        {
            ...
            if (currentambchan == 0)
            {
                if(ambchannel2 != null) ambchannel2.stop();
            }
            if (currentambchan == 1)
            {
                if(ambchannel != null) ambchannel.stop();
